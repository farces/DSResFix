...
{
	//2560 1440
    return(m_pIDirect3DDevice9->CreateRenderTarget(UINT(2560),UINT(1440),Format,MultiSample,MultisampleQuality,Lockable,ppSurface,pSharedHandle));
}
...
{
    return(m_pIDirect3DDevice9->CreateDepthStencilSurface(UINT(2560),UINT(1440),Format,MultiSample,MultisampleQuality,Discard,ppSurface,pSharedHandle));
}
